...
moved {
  from = module.cluster.data.aws_eks_cluster_auth.current
  to   = data.aws_eks_cluster_auth.current
}
...
moved {
  from = module.cluster.data.tls_certificate.current
  to   = data.tls_certificate.current
}
